...
module.exports = (app) => {
    ...
    app.post(process.env.BASE_URL + '/vehicle-details', auth.validateToken, defaultController.create);

    // List available profit-center records
    app.get(process.env.BASE_URL + '/vehicle-details', auth.validateToken, pagination.setAttributes, defaultController.search);

    // View profit-center record
    app.get(process.env.BASE_URL + '/vehicle-details/:id', auth.validateToken, defaultController.get);
